...
Refer to the GitHub [wiki](https://github.com/marcpaelinck/tabuh-studio/wiki) for more information about this
application.
...
Use command `npm version [ major | minor | patch]` to update the version of the frontend/backend. See
https://docs.npmjs.com/cli/v8/commands/npm-version.

This command will also add a tag to the Git repo.
