        ...
        <>
            <VStack spacing={12}>
                <HStack>
                    ...
                    <SiProtondb size={32} />
                    Brand
                    {/* <img src={logo} height="32pt" alt="" /> Tabuh Studio */}
                </HStack>
        ...
        <Container id="main" height="80vh">
            <Container id="header+content">
                ...
                <Content id="content" px="1rem" className="h-9/10">
                    ...
                    <Box id="editor window box" className={`h-17/20 border rounded-md p-2 overflow-scroll`}>
                        {score != null && (
                            <EditorWindow
                                score={score}
                                expanded={expanded}
